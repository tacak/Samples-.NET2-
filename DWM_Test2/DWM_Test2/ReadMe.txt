========================================================================
    Win32 アプリケーション: DWM_Test2 プロジェクトの概要
========================================================================

この DWM_Test2 アプリケーションは、AppWizard により作成されました。
...
DWM_Test2.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル DWM_Test2.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル DWM_Test2.rc 
    にインクルードされます。
