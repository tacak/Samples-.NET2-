========================================================================
    Win32 アプリケーション: DWM_Test プロジェクトの概要
========================================================================

この DWM_Test アプリケーションは、AppWizard により作成されました。
...
DWM_Test.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル DWM_Test.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル DWM_Test.rc 
    にインクルードされます。
