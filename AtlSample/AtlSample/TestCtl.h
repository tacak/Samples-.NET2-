...
class ATL_NO_VTABLE CTestCtl :
	...
	public IDispatchImpl<ITestCtl, &IID_ITestCtl, &LIBID_AtlSampleLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
#endif
	public IProvideClassInfo2Impl<&CLSID_TestCtl, &__uuidof(_ITestCtlEvents), &LIBID_AtlSampleLib>,
