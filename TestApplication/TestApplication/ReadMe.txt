========================================================================
    Win32 アプリケーション: TestApplication プロジェクトの概要
========================================================================

この TestApplication アプリケーションは、AppWizard により作成されました。

このファイルには、TestApplication 
...
TestApplication.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル TestApplication.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル TestApplication.rc 
    にインクルードされます。
